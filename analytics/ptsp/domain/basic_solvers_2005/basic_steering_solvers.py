...
from analytics.ptsp.domain.game.agent_2005 import Agent
from analytics.ptsp.domain.game.ptsp_config import PTSPConfiguration
from analytics.ptsp.domain.game.solution import Solution
